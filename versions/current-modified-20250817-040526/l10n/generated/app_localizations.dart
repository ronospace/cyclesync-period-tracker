...
abstract class AppLocalizations {
  ...
  /// App subtitle/tagline describing CycleSync's purpose
  ///
  /// In en, this message translates to:
  /// **'Your Smart Clinical Period Tracker'**
  ...
  /// Clinical insights subtitle
  ///
  /// In en, this message translates to:
  /// **'Clinical Insights'**
  String get clinicalInsights;

  /// Personalized content subtitle
  ///
  /// In en, this message translates to:
  ...
  /// App branding section title
  ///
  /// In en, this message translates to:
  /// **'App Branding'**
  String get appBrandingTitle;
  ...
  String get customBrandingDescription;
  ...
  /// About dialog title with app name
  ///
  /// In en, this message translates to:
  /// **'About {appName}'**
  ...
  /// In en, this message translates to:
  /// **'Cycle logging and tracking'**
  String get featureCycleTracking;
  ...
  String get featureSmartInsights;
