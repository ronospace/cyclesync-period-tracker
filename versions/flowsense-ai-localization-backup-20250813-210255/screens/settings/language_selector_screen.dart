...
class _LanguageSelectorScreenState extends State<LanguageSelectorScreen> {
  ...
  List<Map<String, dynamic>> _getFilteredLanguages(LocalizationService localizationService) {
    List<Map<String, dynamic>> languages = localizationService.availableLanguages;
    ...
    languages.sort((a, b) => a['name'].toString().compareTo(b['name'].toString()));
  ...
  String _getLanguageRegion(Locale locale) {
    switch (locale.languageCode) {
      ...
      case 'es':
      case 'pt':
        return locale.countryCode == 'BR' || locale.countryCode == 'US' || locale.countryCode == 'MX' 
            ? 'Americas' : 'Europe';
      case 'fr':
      case 'de':
      case 'it':
  ...
  Widget _buildLanguageItem(
    ...
    return Container(
      ...
      child: Material(
        color: isSelected ? AppTheme.primaryPink.withOpacity(0.1) : Colors.white,
        borderRadius: BorderRadius.circular(12),
        child: InkWell(
          borderRadius: BorderRadius.circular(12),
          onTap: () async {
                    ...
                    children: [
                      Text(
                        ...
                        style: TextStyle(
                          ...
                          fontSize: 16,
                          color: isSelected ? AppTheme.primaryPink : Colors.black87,
                        ),
                      ),
        ...
        content: const SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 8),
              Text('📍 Europe: German, French, Italian, Russian, Polish, Dutch, Swedish, Norwegian, Danish, Finnish, Czech, Hungarian, Romanian, Ukrainian'),
              SizedBox(height: 8),
              Text('📍 Asia Pacific: Chinese, Japanese, Korean, Hindi, Thai, Vietnamese, Indonesian, Malay, Bengali'),
              SizedBox(height: 8),
              Text('📍 Middle East & Africa: Arabic, Turkish, Hebrew, Swahili, Urdu, Persian'),
              SizedBox(height: 16),
              Text(
