...
void main() async {
  ...
  try {
    ...
    debugPrint('FlowSense: Firebase initialized successfully');
  } catch (e) {
    debugPrint('FlowSense: Firebase initialization error: $e');
  }
      ...
      body: Center(
        child: Column(
          ...
          children: <Widget>[
            ...
            const Text(
              'Your intelligent flow tracking companion',
              style: TextStyle(
                fontSize: 16,
                color: Colors.grey,
              ),
...
class HomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('FlowSense Home'),
        backgroundColor: Theme.of(context).colorScheme.inversePrimary,
      ),
      body: Padding(
