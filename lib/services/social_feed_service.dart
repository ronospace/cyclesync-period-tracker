...
class SocialFeedService {
  static const List<String> _anonymousNames = [
    ...
    'CycleSync', 'FlowFree', 'PinkPower', 'MoonMagic', 'FlowVibes',
    'CycleStar', 'PeriodPro', 'FlowFriend', 'MoonBeam', 'WellnessWin',
    'CycleSage', 'FlowFab', 'PeriodPal', 'MoonGlow', 'WellnessWiz',
    'CycleChamp', 'FlowFinesse', 'PeriodPrincess', 'MoonRise', 'WellnessWin'
  ];

  static const List<String> _globalLocations = [
    'Global', 'North America', 'Europe', 'Asia', 'Australia', 'Africa',
    'South America', 'Anonymous', 'Worldwide'
  ];

  static const List<String> _trendingTopics = [
    'periodflu', 'cyclehacks', 'pms', 'periodpositivity', 'flowfriendly',
    'cyclescience', 'periodpower', 'menstrualtips', 'cyclecare', 'periodlife',
    'flowvibes', 'cyclefacts', 'periodstories', 'menstrualhealth', 'cyclewise',
    'periodproblems', 'flowsupport', 'cyclecommunity', 'periodboss', 'flowstrong'
  ];

  static final Map<FeedCategory, List<Map<String, dynamic>>> _samplePosts = {
    FeedCategory.forYou: [
      {
        'content': 'Just discovered that dark chocolate actually helps with cramps! 🍫 My period pain went from a 7 to a 3 after eating some. Anyone else experience this magic?',
      ...
      {
        'content': 'PSA: Your period coming early when you\'re stressed is completely normal! Your body is just responding to cortisol levels. Be kind to yourself ❤️',
      ...
      {
        'content': 'Anyone else get super emotional the day before their period starts? Like I literally cried watching a dog video yesterday 😅',
    ...
    FeedCategory.stories: [
      {
        'content': 'Story time: I got my first period at a friend\'s sleepover and was mortified. Now I realize how normal and beautiful it is. Sharing for anyone feeling embarrassed ✨',
      ...
      {
        'content': 'My mom never talked to me about periods, so I\'m breaking the cycle. Had the most beautiful conversation with my little sister about menstruation today 💕',
    ...
    FeedCategory.tips: [
      {
        'content': 'Period hack: Track your mood alongside your cycle! I noticed I\'m most creative during ovulation and most introspective during my period 🎨',
      ...
      {
        'content': 'Heat pad alternative: Fill a clean sock with rice, tie it off, and microwave for 1-2 minutes. Instant heat therapy! 🧦',
    ...
    FeedCategory.support: [
      {
        'content': 'To anyone struggling with irregular periods: you\'re not alone. It took me 2 years to find the right doctor who listened. Keep advocating for yourself 💪',
      ...
      {
        'content': 'Reminder: Period poverty is real. If you can afford to, donate pads/tampons to local shelters. Let\'s support each other 🤝',
  ...
  static Future<List<FeedPost>> getFeedPosts({
    ...
    final categoryPosts = _samplePosts[category] ?? _samplePosts[FeedCategory.forYou]!;
  ...
  static Future<List<Comment>> getComments(String postId, {int limit = 50}) async {
  ...
  static Future<List<FeedPost>> searchPosts(String query, {int limit = 20}) async {
