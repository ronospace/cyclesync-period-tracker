...
class AnalyticsConfig {
  ...
  static Future<void> _configureAnalytics() async {
    ...
    developer.log(
      '📊 Firebase Analytics configured with healthcare compliance',
    );
  }
  ...
  static Future<void> _configureCrashlytics() async {
    ...
    await _crashlytics!.setCustomKey(
      'hipaa_mode',
      ProductionConfig.enableHIPAAMode,
    );
    await _crashlytics!.setCustomKey(
      'encryption_enabled',
      ProductionConfig.enableEncryption,
    );
  ...
  static Future<void> _configurePerformanceMonitoring() async {
    ...
    trace.setMetric(
      'encryption_enabled',
      ProductionConfig.enableEncryption ? 1 : 0,
    );
  ...
  static Map<String, dynamic> _sanitizeSensitiveData(
