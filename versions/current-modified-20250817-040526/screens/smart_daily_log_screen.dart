    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          if (_aiInsights.isNotEmpty || _predictions != null)
            Card(
                    ...
                    children: [
                        ...
                        children: [
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                Text(
                                  AppLocalizations.of(context).aiInsights ?? 'AI Insights',
                                  style: TextStyle(
                                    fontWeight: FontWeight.bold,
                                    fontSize: 16,
                                ...
                                Text(
                                  AppLocalizations.of(context).personalizedForYou ?? 'Personalized for you',
                                  style: TextStyle(
                          ...
                          const AIPoweredBadge(isSmall: true),
                        ],
                      ),
                      const SizedBox(height: 12),
                      if (_aiInsights.isNotEmpty) ...[
                        Text(
                          _aiInsights.first.title,
                          style: const TextStyle(
                        ...
                        Text(
                          _aiInsights.first.message.length > 100
                              ? '${_aiInsights.first.message.substring(0, 100)}...'
                              : _aiInsights.first.message,
                          style: TextStyle(
                            color: Colors.grey.shade700,
                            fontSize: 13,
                          ),
                        ),
                      ] else if (_predictions?['next_period'] != null) ...[
                        Text(
                          AppLocalizations.of(context).nextPeriod ?? 'Next Period Prediction',
                          style: const TextStyle(
                            fontWeight: FontWeight.w600,
                            fontSize: 14,
                          ),
                        ...
                        const SizedBox(height: 4),
                        Text(
                          '${AppLocalizations.of(context).expectedOn ?? 'Expected on'} ${_predictions!['next_period']['date']}',
                          style: TextStyle(
                            color: Colors.grey.shade700,
                            fontSize: 13,
                          ),
                      ...
                      Row(
                        ...
                        children: [
                          TextButton(
                            onPressed: () {
                              _tabController.animateTo(3); // Switch to AI Insights tab
                            },
                            child: Text(
                              AppLocalizations.of(context).viewAllInsights ?? 'View All Insights',
                              style: TextStyle(
                                color: Colors.purple.shade600,
                                fontWeight: FontWeight.w600,
                                fontSize: 12,
