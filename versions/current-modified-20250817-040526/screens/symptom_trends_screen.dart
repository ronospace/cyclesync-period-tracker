...
class _SymptomTrendsScreenState extends State<SymptomTrendsScreen> with TickerProviderStateMixin {
  ...
  Widget _buildHeader() {
    return Container(
      ...
      decoration: FuturisticTheme.gradientDecoration(
        colors: FuturisticTheme.pinkPurpleGradient,
        borderRadius: 20,
      ),
      child: Padding(
      ...
      child: Column(
        children: [
          ...
          Container(
            ...
            decoration: FuturisticTheme.gradientDecoration(
              colors: FuturisticTheme.bluePurpleGradient,
              borderRadius: 20,
            ),
            child: Padding(
              padding: const EdgeInsets.all(20),
                    ...
                    child: BarChart(
                      BarChartData(
                          ...
                          bottomTitles: AxisTitles(
                            sideTitles: SideTitles(
                              ...
                              getTitlesWidget: (value, meta) {
                                ...
                                final colors = [
                                  FuturisticTheme.primaryPink,
                                  FuturisticTheme.primaryPurple,
                                  FuturisticTheme.primaryBlue,
                                  FuturisticTheme.primaryGreen,
                                  FuturisticTheme.primaryAmber,
                                ];
                                final color = colors[value.toInt() % colors.length];
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      SizedBox(
                                        width: 50,
                                        child: Text(
                                          _getShortSymptomName(symptom?.displayName ?? symptomName),
                                          style: TextStyle(
                                            fontSize: 9,
                                            color: color,
                        ...
                        barGroups: sortedSymptoms.asMap().entries.map((entry) {
                          ...
                          // Use consistent gradient colors from FuturisticTheme
                          final colors = [
                            FuturisticTheme.primaryPink,
                            FuturisticTheme.primaryPurple,
                            FuturisticTheme.primaryBlue,
  ...
  String _getShortSymptomName(String fullName) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Container(
        decoration: FuturisticTheme.gradientDecoration(
          colors: FuturisticTheme.greenBlueGradient,
          borderRadius: 0,
        ),
        child: _isLoading
            ? Center(
                  ...
                  child: Column(
                    ...
                    children: [
                      CircularProgressIndicator(
                        valueColor: AlwaysStoppedAnimation<Color>(FuturisticTheme.primaryPink),
                      ),
                      const SizedBox(height: 16),
                      const Text(
                        'Loading symptom trends...',
                        ...
                        children: [
                          ...
                          ElevatedButton.icon(
                            ...
                            style: ElevatedButton.styleFrom(
                              backgroundColor: FuturisticTheme.primaryPink,
