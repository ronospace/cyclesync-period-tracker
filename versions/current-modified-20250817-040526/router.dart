...
import 'screens/enhanced_settings_screen.dart'; // ⚙️ ENHANCED
  ...
  static GoRouter router(BuildContext context) {
    ...
    return GoRouter(
      ...
      routes: [
        ...
        // Display name setup route (used in settings)
        GoRoute(
          path: '/display-name-setup',
          builder: (context, state) => Scaffold(
            appBar: AppBar(
              title: const Text('Display Name Setup'),
            ),
            body: const Center(
              child: Text('Custom display name setup will be handled in settings dialog.'),
            ),
          ),
        ),
      ],
